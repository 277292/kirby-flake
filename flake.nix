{
  ...
  outputs = {self, nixpkgs, ...}: {
    ...
    in {
      fetch = {version, rev, sha256, phpPackage}: mkDerivation {
        pname = "kirby";
        inherit version;
        src = fetchFromGitHub {
          owner = "getkirby";
      ...
      kirby5 = fetch {
        version = "5.0.0-rc.6";
        rev = "eff9881fb1e4ac7b4f5d7d115f1d5f0a2d2c2a90";
        sha256 = "sha256-q+CIsuDmO0zddEI2PzceqS20gtT7UDkULSSiwVfHQo4=";
        phpPackage = php84;
      };
    };
    ...
    in {
      ...
      config = {
        ...
        services.phpfpm.pools = mapAttrs (name: {enable, timezone, package, ...}: mkIf enable {
          user = name;
